...
# Dodajemy folder fetcher do ścieżki importów
...
# Tworzymy folder na logi jeśli nie istnieje
...
if __name__ == "__main__":
    log.info("Scheduler uruchomiony — fetchery będą odpалać się co 24h o 06:00")
